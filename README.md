...
```git
git clone https://github.com/chatrix/nova-poshta-v2
```
### Composer
...
{
    "require": {
        "chatrix/nova-poshta-v2": "dev-master"
    }
}
```
...
```
composer require chatrix/nova-poshta-v2:dev-master
```
### Альтернативная установка
Необходимо скачать архив по ссылке
```
https://github.com/chatrix/nova-poshta-v2/archive/master.zip
```
# Форматы данных
